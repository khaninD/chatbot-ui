...
function addApiKeysToProfile(profile: Tables<"profiles">) {
  const apiKeys = {
    [VALID_ENV_KEYS.LLM_API_KEY]: "openai_api_key",
  ...
  // Handle specialized Azure keys or OpenAI org separately if needed
  if (process.env.NEXT_PUBLIC_OPENAI_ORGANIZATION_ID) {
